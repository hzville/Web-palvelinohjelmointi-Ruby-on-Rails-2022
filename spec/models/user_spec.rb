...
RSpec.describe User, type: :model do
  ...
  it "is not saved with password containing only lowercase letters" do
    user = User.create  username: "Pekka", password: "testpassword", password_confirmation: "testpassword"
